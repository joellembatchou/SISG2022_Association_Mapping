...
kableExtra::kable_styling(bootstrap_options = c("hover", "condensed","striped"))
```
Link to Day 2 video: `r print.link("Zoom recording", "https://cloudstor.aarnet.edu.au/plus/s/9qPj8ZlGCTh8nTt")`
...
kableExtra::kable_styling(bootstrap_options = c("hover", "condensed","striped"))
```
Link to Day 3 video: `r print.link("Zoom recording", "https://cloudstor.aarnet.edu.au/plus/s/edR12nsfDxD9IiV")`
