...
data.frame(
  ...
  "Exercises" = c(
    ...
    paste0(print.link("Exercises", "SISGM15_prac4"), ", ", "Video")
  ),
  "Key" = c(
		...
		paste0(print.link("HTML", "SISGM15_prac4.html"), ", ", print.link("Rmd", "https://www.dropbox.com/s/z28kt49c9wxglfd/SISGM15_prac4.Rmd?dl=0"))
  )
 , check.names = FALSE ) %>%
