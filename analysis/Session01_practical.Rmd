...
3. Obtain odds ratios and confidence intervals for the `CT` and `TT` genotypes.

4. Now redo the logistic regression analysis from question 2, but with `TT` as the reference genotype. 
  * How do the results change? Explain. 
  (Hint: Use a plot to gain some insight.)
  
## Association Testing with Quantitative Traits

### Introduction
We will be using the [Blood Pressure dataset](https://raw.githubusercontent.com/joellembatchou/SISG2022_Association_Mapping/master/data/LHON.txt) for this portion of the exercises.
