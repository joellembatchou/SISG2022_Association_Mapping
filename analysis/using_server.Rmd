...
You can use `pkill ssh` to terminate the ssh session (so you won't be able to access RStudio server from your browser anymore); until then it will remain accessible unless you restart your computer.
