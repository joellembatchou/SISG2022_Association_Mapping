...
(Hint: convert p-values to $\chi^2_1$ test statistics using the R function `qchisq(<pvals>, df = 1, lower.tail = FALSE)`)

7. Now use REGENIE to perform a GWAS of the transferrin phenotype
...
```{bash, eval = FALSE}
regenie --bed Transferrin_height --phenoFile Transferrin_pheno.txt --keep <nomiss.ids> --step 2 --bsize 400 --qt --pred <output_prefix_step1>_pred.list --extract <plink_variant_list_file> --out <output_prefix_step2>
```  
