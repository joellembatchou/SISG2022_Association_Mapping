...
\begin{tabular}{cc}
\raisebox{.1in}{\includegraphics[scale=.5]{Figures/Loic_Yengo.jpeg}} &
\raisebox{1.2in}{
\begin{minipage}{6in}
\begin{itemize}
\item A
...
\begin{tabular}{cc}
\raisebox{.03in}{\includegraphics[scale=.4]{Figures/Joelle_Mbatchou.jpeg}} &
\raisebox{.9in}{
\begin{minipage}{7in}
\begin{itemize}
...
\begin{center}
	...
	\begin{minipage}{0.24\linewidth}
		...
		\captionof{figure}{Andrea Horimoto}
	\end{minipage}%
	\hfill
	\begin{minipage}{0.24\linewidth}
